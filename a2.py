...
class ComputerPlayer(Player):
    ...
    def pick_card(self, putdown_pile):
        ...
        for card in self.get_deck().get_cards():
            if card.get_pickup_amount() == 4:
                self.get_deck().get_cards().remove(card)
                return card
            elif card.matches(putdown_pile.top()):
                self.get_deck().get_cards().remove(card)
                putdown_pile.add_card(card)
                return card
        return None
...
class Card(object):
    ...
    def matches(self, card):
        ...
        """
        if self._number == card.get_number() or self._colour == card.get_colour():
            return True
        else:
            return False
...
class SkipCard(Card):
    ...
    def __str__(self):
        """Returns the string representation of the skip card."""
...
class ReverseCard(Card):
    ...
    def __str__(self):
        """Returns the string representation of the reverse card."""
...
class Pickup2Card(Card):
    ...
    def __str__(self):
        """Returns the string representation of the Pickup2Card."""
...
class Pickup4Card(Card):
    ...
    def __str__(self):
        """Returns the string representation of the Pickup4Card."""
